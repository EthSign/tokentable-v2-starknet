...
// OpenZeppelin Contracts for Cairo v0.8.0 (token/erc721/erc721.cairo)
// Modified by Jack Xu @ EthSign

#[starknet::interface]
trait IERC721TTCustom<TState> {
    fn get_allow_transfer(
        self: @TState
    ) -> bool;
}
...
mod ERC721Component {
    ...
    struct Storage {
        ...
        // Custom
        ERC721_token_base_uri: felt252,
        ERC721_allow_transfer: bool,
    }
    ...
    mod Errors {
        ...
        // Custom
        const TRANSFER_NOT_ALLOWED: felt252 = 'ERC721: transfer not allowed';
    }

    //
    // Custom External
    //
    #[embeddable_as(ERC721TTCustomImpl)]
    impl ERC721TTCustom<
        TContractState,
        +HasComponent<TContractState>,
        +SRC5Component::HasComponent<TContractState>,
        +Drop<TContractState>
    > of super::IERC721TTCustom<ComponentState<TContractState>> {
        fn get_allow_transfer(
            self: @ComponentState<TContractState>
        ) -> bool {
            self.ERC721_allow_transfer.read()
        }
    }
    ...
    > of InternalTrait<TContractState> {
        ...
        /// Sets if transfer is enabled
        /// Custom
        fn _set_allow_transfer(
            ref self: ComponentState<TContractState>,
            allow_transfer: bool
        ) {
            self.ERC721_allow_transfer.write(allow_transfer);
        }
    }
