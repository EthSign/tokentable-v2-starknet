...
/// OpenZeppelin Contracts for Cairo v0.17.0 (token/erc721/erc721.cairo)
...
pub mod ERC721Component {
    ...
    pub mod Errors {
        ...
        // Custom
        pub const TRANSFER_NOT_ALLOWED: felt252 = 'ERC721: transfer not allowed';
    }
    ...
    > of super::IERC721TTCustom<ComponentState<TContractState>> {
        fn get_allow_transfer(self: @ComponentState<TContractState>) -> bool {
